...
var UserService = (_dec = Injectable(), _dec2 = function _dec2(target, key) {
  ...
  return _createClass(UserService, [{
    ...
    key: "findAllUsers",
    value: function () {
      var _findAllUsers = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
        var _this = this;
        var page,
          limit,
          skip,
        ...
        return _regenerator().w(function (_context10) {
          while (1) switch (_context10.n) {
            case 0:
              ...
              limit = _args10.length > 1 && _args10[1] !== undefined ? _args10[1] : 12;
              skip = (page - 1) * limit;
              _context10.n = 1;
              return Promise.all([this.UserModel.find({}).select('-password').sort({
                createdAt: -1
              }).skip(skip).limit(limit).exec(), this.UserModel.countDocuments({})]);
            case 1:
              _yield$Promise$all = _context10.v;
              _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 2);
              data = _yield$Promise$all2[0];
              total = _yield$Promise$all2[1];
              normalizedData = data.map(function (doc) {
                return _this.normalizeUser(doc);
              });
    ...
    key: "deleteUser",
    value: function () {
      var _deleteUser = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11(id) {
        return _regenerator().w(function (_context11) {
          while (1) switch (_context11.n) {
            case 0:
              return _context11.a(2, this.UserModel.findByIdAndDelete(id).exec());
          }
        }, _callee11, this);
      }));
